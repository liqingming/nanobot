...
# asyncio TCP server / 19999 closed-port probe hangs on Windows ProactorEventLoop;
# the underlying probe logic itself is platform-agnostic and verified on POSIX CI.
pytestmark = pytest.mark.skipif(
    sys.platform == "win32",
    reason="asyncio TCP server / closed-port probe hangs on Windows ProactorEventLoop",
)
