...
def unified_diff_preview(
    ...
    *,
    ...
    """Return legacy text diff fields consumed by the fork TUI."""
...
def build_file_edit_end_event(
    ...
    legacy_diff = unified_diff_preview(before_text, after_text, path=tracker.display_path)
    if legacy_diff is not None:
        payload.update(legacy_diff)
    return payload
