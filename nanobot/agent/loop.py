...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        return cls(
            ...
            skill_roots=defaults.skill_roots,
    ...
    async def _state_run(self, ctx: TurnContext) -> str:
        ...
        if (
            ...
            nudge = {"role": "user", "content": self.nudge_after_empty_tools_message}
            (
                r_content, r_tools, r_msgs, r_stop, _had_injections,
                r_usage, r_events,
            ...
            if r_content is not None:
                ...
                stop_reason = r_stop
                had_injections = had_injections or _had_injections
