    ...
    *,
    ...
    payload = {
        ...
        "advanced": {
            ...
            "private_service_protection_enabled": not config.tools.allow_private_network_access,
            "private_network_access_enabled": config.tools.allow_private_network_access,
